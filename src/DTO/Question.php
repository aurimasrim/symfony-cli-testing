...
class Question implements QuestionInterface
{
     ...
     */
    public function __construct(string $question, string $category, Answers $answers, string $help = null, QuestionEntity $entity)
    {
    ...
    public function getEntity(): QuestionEntity
    {
        return $this->entity;
    }
}
